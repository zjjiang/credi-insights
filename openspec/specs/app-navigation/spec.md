...
Defines the persistent navigation chrome for the app: its structure, placement, active-state behavior, and viewport scope. Introduced to replace the previous fixed-bottom tab bar with a persistent top navigation bar suited to desktop/wide-viewport usage.
